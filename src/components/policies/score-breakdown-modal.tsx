            ...
            <div className="absolute max-w-full -translate-x-1/2 -translate-y-1/2 bg-white shadow-2xl top-1/2 left-1/2 w-[700px] rounded-3xl overflow-y-auto max-h-full">
                ...
                <div className="p-4 lg:p-8">
                    ...
                    <div className="flex items-center gap-2 py-2">
                        ...
                        <p className="flex-1 text-gray-600">{t('policies.scoring_breakdown.partial_support')}: <span className="text-gray-500">{t('policies.scoring_breakdown.half_points')}</span></p>
                    </div>
                    <div className="flex items-center gap-2 py-2">
                        <div className="flex-shrink">
                            <SupportTick color="gray" full={true}/>
                        </div>
                        <p className="flex-1 text-gray-600">{t('policies.scoring_breakdown.full_support')}: <span className="text-gray-500">{t('policies.scoring_breakdown.full_points')}</span></p>
                    </div>
                    <p className="text-lg font-medium text-gray-700 mt-2">{t('policies.scoring_breakdown.final_score_title')}</p>
